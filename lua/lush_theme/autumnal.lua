...
local theme = lush(function(injected_functions)
	...
	return {
		...
		BufferCurrent = { fg = CumulousGray },
		BufferCurrentERROR = { fg = BloodRed },
		BufferCurrentHINT = { fg = CrispBlueSky },
		-- BufferCurrentIcon = { },
		BufferCurrentINFO = { fg = PumpkinOrange },
		BufferCurrentWARN = { fg = LingeringLeaf },
		BufferCurrentIndex = { fg = SunsetGold },
		BufferCurrentMod = { bg = Cider },
		BufferCurrentSign = { fg = CumulousGray },
		BufferCurrentTarget = { fg = White },

		BufferVisible = { fg = OvercastGray },
		BufferVisibleERROR = { fg = SunsetRed },
		BufferVisibleHINT = { fg = HazyBlueSky },
		-- BufferVisibleIcon = { },
		BufferVisibleINFO = { fg = Rust },
		BufferVisibleWARN = { fg = Evergreen },
		BufferVisibleIndex = { fg = PumpkinOrange },
		BufferVisibleMod = { bg = Wine },
		BufferVisibleSign = { fg = OvercastGray },
		BufferVisibleTarget = { fg = CumulousGray },
		...
		BufferInactive = { fg = OvercastGray },
		BufferInactiveERROR = { fg = SunsetRed },
		BufferInactiveHINT = { fg = HazyBlueSky },
		-- BufferInactiveIcon = { },
		BufferInactiveINFO = { fg = Rust },
		BufferInactiveWARN = { fg = Evergreen },
		BufferInactiveIndex = { fg = PumpkinOrange },
		BufferInactiveMod = { bg = Wine },
		BufferInactiveSign = { fg = OvercastGray },
		BufferInactiveTarget = { fg = CumulousGray },
